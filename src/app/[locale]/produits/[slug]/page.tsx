    ...
    <div className="section-padding bg-premium-dark">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 mb-12 lg:mb-20">
          <div className="relative bg-premium-card/60 backdrop-blur-sm border border-premium-border rounded-2xl p-4 sm:p-6 lg:p-10 flex items-center justify-center min-h-[220px] sm:min-h-[350px] lg:min-h-[450px]">
            <ImageWithFallback
              src={product.image}
              alt={product.name}
