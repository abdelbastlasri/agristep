          ...
          {categories.map((cat) => {
            ...
            return (
              ...
              >
                ...
                <h2 className="font-heading text-xl text-premium-dark mb-3 group-hover:text-premium-warm transition-colors">
                  {ct(cat.id)}
                </h2>
                ...
                <div className="flex items-center justify-between">
                  <span className="text-xs text-premium-warm font-medium">
                    {count} produit{count > 1 ? "s" : ""}
                  </span>
                  <span className="text-premium-warm group-hover:translate-x-1 transition-transform">
                    →
                  </span>
                </div>
              </Link>
