      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          <div className="space-y-6">
            <div className="bg-white border border-premium-border rounded-2xl p-5 sm:p-6">
            ...
            <a
              ...
              className="bg-white border border-premium-border rounded-2xl p-5 sm:p-6 flex items-center gap-4 hover:border-premium-gold/30 hover:shadow-[0_0_30px_rgba(212,168,83,0.08)] group transition-all duration-300"
            >
            ...
            <div className="bg-white border border-premium-border rounded-2xl overflow-hidden">
              <iframe
