...
export default function ContactForm() {
  ...
  return (
    <div className="bg-premium-cream border border-premium-border/20 rounded-2xl shadow-sm p-5 sm:p-6 lg:p-10">
      <form onSubmit={handleSubmit} className="space-y-5">
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                type="text"
                required
                className="w-full px-4 py-3 bg-premium-cream border border-premium-border/30 rounded-lg input-glow text-sm text-premium-dark focus:border-premium-dark"
          ...
          <div>
            ...
            <textarea
              ...
              required
              rows={5}
              className="w-full px-4 py-3 bg-premium-cream border border-premium-border/30 rounded-lg input-glow text-sm text-premium-dark resize-none"
              value={form.message}
