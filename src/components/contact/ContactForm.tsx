...
export default function ContactForm() {
  ...
  return (
    <div className="bg-premium-card/60 backdrop-blur-sm border border-premium-border rounded-2xl p-5 sm:p-6 lg:p-10">
      <form onSubmit={handleSubmit} className="space-y-5">
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                type="text"
                required
                className="w-full px-4 py-3 bg-premium-dark border border-premium-border rounded-lg input-glow text-sm text-white focus:border-premium-green"
          ...
          <div>
            ...
            <textarea
              ...
              required
              rows={5}
              className="w-full px-4 py-3 bg-premium-dark border border-premium-border rounded-lg input-glow text-sm text-white resize-none"
              value={form.message}
