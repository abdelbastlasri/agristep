...
export default function ContactForm() {
  ...
  return (
    <div className="bg-white border border-gray-100 rounded-2xl shadow-sm p-5 sm:p-6 lg:p-10">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                type="text"
                required
                className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg input-glow text-sm text-premium-dark"
