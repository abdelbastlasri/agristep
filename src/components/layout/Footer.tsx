...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-premium-dark text-white/80 overflow-hidden">
      ...
      {/* Top divider */}
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-premium-accent/40 to-transparent" />
      <div className="max-w-7xl mx-auto px-6 py-16 relative z-10">
        <div className="md:hidden space-y-10">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div>
              <h3 className="text-xs uppercase tracking-[0.2em] text-premium-accent font-semibold mb-5">
                {t("navigation")}
              </h3>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li className="flex items-start gap-2">
                  <span className="text-premium-accent flex-shrink-0">📍</span>
                ...
                <li className="flex items-center gap-2">
                  <span className="text-premium-accent flex-shrink-0">✉️</span>
                ...
                <li className="flex items-center gap-2">
                  <span className="text-premium-accent flex-shrink-0 social-icon">💼</span>
        ...
        <div className="hidden md:grid md:grid-cols-3 gap-12">
          ...
          <div>
            <h3 className="text-xs uppercase tracking-[0.2em] text-premium-accent font-semibold mb-6">
              {t("navigation")}
            </h3>
            <ul className="space-y-3">
              <li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-start gap-3">
                <span className="text-premium-accent flex-shrink-0 mt-0.5">📍</span>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 text-center">
          <div className="w-16 h-px bg-gradient-to-r from-transparent via-premium-accent/50 to-transparent mx-auto mb-6" />
